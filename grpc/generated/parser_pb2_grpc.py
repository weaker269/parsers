...
class ParserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ParseFile = channel.unary_unary(
                '/parser.ParserService/ParseFile',
        ...
        self.HealthCheck = channel.unary_unary(
                '/parser.ParserService/HealthCheck',
                request_serializer=parser__pb2.HealthCheckRequest.SerializeToString,
                response_deserializer=parser__pb2.HealthCheckResponse.FromString,
                _registered_method=True)
...
def add_ParserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'HealthCheck': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=parser__pb2.HealthCheckRequest.FromString,
                    response_serializer=parser__pb2.HealthCheckResponse.SerializeToString,
            ),
    }
...
class ParserService(object):
    ...
    def HealthCheck(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/parser.ParserService/HealthCheck',
            parser__pb2.HealthCheckRequest.SerializeToString,
            parser__pb2.HealthCheckResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
